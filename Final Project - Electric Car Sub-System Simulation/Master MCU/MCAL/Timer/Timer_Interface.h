...
typedef enum Timer2_init{
	...
	EN_TIMER2_CTC,
	EN_TIMER2_PWM ,
	EN_TIMER2_PHASECORRECT,
	/* CTC OC2*/
	EN_TIMER2_CTC_OC2_Disconnected = 0,
	EN_TIMER2_CTC_Toggle_OC2,
	EN_TIMER2_CTC_Clear_OC2,
	EN_TIMER2_CTC_Set_OC2,
	/*PWM OC2	*/
	EN_TIMER2_PWM_OC2_Disconnected = 0,
	EN_TIMER2_PWM_Clear_OC2_On_Compare_Match = 2,
	EN_TIMER2_PWM_Set_OC2_On_Compare_Match,
	/*PhaseCorrect OC2*/
	EN_TIMER2_PC_OC2_Disconnected = 0,
	EN_TIMER2_PC_Clear_OC2_Upcounting  = 2,
	EN_TIMER2_PC_Set_OC2_Upcounting,
	/*Timer2_Interrupts*/
	EN_TIMER2_IntDisable = 0 ,
	EN_TIMER2_IntEnable,
	/*Prescaling*/
	EN_TIMER2_Stop_Timer =0,
	EN_TIMER2_No_Prescaling,
	EN_TIMER2_P_8,
	EN_TIMER2_P_32,
	EN_TIMER2_P_64,
	EN_TIMER2_P_128,
...
/*			Timer 2			*/
void TIMER2_VidInit(st_TIMER2 * TIMER0);
