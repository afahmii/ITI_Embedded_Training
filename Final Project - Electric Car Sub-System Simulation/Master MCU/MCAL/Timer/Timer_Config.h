...
#define TIMER0_COMPARE_MATCH_OUTPUT_MODE	TIMER0PWM_Clear_OC0_On_Compare_Match
...
#define TIMER1_COMPARE_MATCH_VALUE			1000
...
/*	Configure this file using the enum in "Timer_Interface.h" File	*/
#define TIMER2_MODE 						EN_TIMER2_CTC
#define TIMER2_INTERRUPT_STATUS 			EN_TIMER2_IntEnable
#define TIMER2_COMPARE_MATCH_OUTPUT_MODE	EN_TIMER2_CTC_Clear_OC2
#define TIMER2_COMPARE_MATCH_VALUE 			125
#define TIMER2_DUTY_CYCLE 					0
#define TIMER2_PRESCALER_SECLECTOR 			EN_TIMER2_P_64
